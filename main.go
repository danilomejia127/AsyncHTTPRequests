...
func main() {
	...
	// Addictionally, we change the channels to buffered channels, cause otherwise they will block at sending to the channel and never return nil
	// or and error
...
// SendPostAsync send a HTTP Post request to the given URL an puts the response into the given response channel rc
